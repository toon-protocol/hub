/**
 * Connector Admin Client for Hub (Story 21.3, contract aligned in 21.7.5).
 *
 ...
 * Hub currently runs both ports on the same host, so callers either
...
export class ConnectorAdminClient {
   ...
   *
   * Hub-Side Contract: see packages/sdk/CONNECTOR_MIGRATION.md §getPacketLog.

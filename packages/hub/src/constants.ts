/**
 * Shared constants for Hub package.
 *
 * Single source of truth for values used across multiple modules
 * (orchestrator, config-generator, CLI).
 */

/** Container name prefix for all Hub-managed Docker containers */
export const CONTAINER_PREFIX = 'hub-';
...
export const DEFAULT_CONNECTOR_IMAGE =
  ...
  // Patch bump — no SDK/admin contract change vs 3.10.1; bumped because hub
  ...
  // SDK/admin contract change vs 3.10.0; bumped because hub needs the
 ...
 *      `.github/workflows/publish-hub-images.yml`.
 *

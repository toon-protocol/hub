...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  wallet_already_exists:
    'A wallet already exists in your Townhouse config directory. Stop the wizard, delete `wallet.enc` from your config directory, and re-run `townhouse setup`.',
  config_already_exists:
    'A config already exists in your Townhouse config directory. Stop the wizard, delete `config.yaml`, and re-run `townhouse setup`.',
};
